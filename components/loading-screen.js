export const LoadingScreen = () => {
  return (
    <main className="flex h-screen w-screen items-center justify-center animate-pulse">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 220 206" className="h-14">
        <path
          stroke="#000"
          strokeLinecap="round"
